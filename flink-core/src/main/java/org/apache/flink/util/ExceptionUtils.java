...
public final class ExceptionUtils {
	...
	public static final String TM_METASPACE_OOM_ERROR_MESSAGE = String.format(
	...
	public static boolean isMetaspaceOutOfMemoryError(Throwable t) {
		return t instanceof OutOfMemoryError && t.getMessage().startsWith("Metaspace");
	}
	...
	public static boolean isDirectOutOfMemoryError(Throwable t) {
		return t instanceof OutOfMemoryError && t.getMessage().startsWith("Direct buffer memory");
	}

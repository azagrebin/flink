...
public class MemoryUtils {
	 ...
	 */
	static Runnable createMemoryGcCleaner(@Nullable Object owner, long address) {
		return createGcCleaner(owner, () -> releaseUnsafe(address));
	}

	@SuppressWarnings("UseOfSunClasses")
	private static Runnable createGcCleaner(@Nullable Object owner, Runnable toClean) {

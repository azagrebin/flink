...
public class TtlUpdateContext<UV, GV> implements Serializable {
	...
	public TtlUpdateContext(int key, String verifierId, GV valueBeforeUpdate, UV update, GV updatedValue) {
		this(key, verifierId, valueBeforeUpdate, update, updatedValue, System.currentTimeMillis());
	}

	private TtlUpdateContext(int key, String verifierId, GV valueBeforeUpdate, UV update, GV updatedValue, long timestamp) {
		this.key = key;

...
class TtlMapStateVerifier
	extends AbstractTtlStateVerifier<MapStateDescriptor<String, String>, MapState<String, String>, Map<String, String>, Tuple2<String, String>, Map<String, String>> {
	...
	@Override
	Map<String, String> getInternal(MapState<String, String> state) throws Exception {
		return StreamSupport.stream(state.entries().spliterator(), false)
			.collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
	}

	@Override
	void updateInternal(MapState<String, String> state, Tuple2<String, String> update) throws Exception {
		state.put(update.f0, update.f1);
	}

	@Override
	Map<String, String> expected(List<TtlValue<Tuple2<String, String>>> updates, long currentTimestamp) {

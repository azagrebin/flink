...
public class RocksDbMultiClassLoaderTest {
	...
	public void testTwoSeparateClassLoaders() throws Exception {
		...
		final ClassLoader loader1 = FlinkUserCodeClassLoaders.childFirst(new URL[] { codePath1, codePath2 }, parent, new String[0], EMPTY_EXCEPTION_HANDLER);
		final ClassLoader loader2 = FlinkUserCodeClassLoaders.childFirst(new URL[] { codePath1, codePath2 }, parent, new String[0], EMPTY_EXCEPTION_HANDLER);

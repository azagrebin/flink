...
public class ResultPartitionBuilder {
	...
	public ResultPartition build() {
		...
		FunctionWithException<BufferPoolOwner, BufferPool, IOException> factory = bufferPoolFactory == null ?
			resultPartitionFactory.createBufferPoolFactory(numberOfSubpartitions, partitionType) : bufferPoolFactory;

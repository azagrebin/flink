...
public abstract class ResourceManager<WorkerType extends ResourceIDRetrievable>
	...
	public CompletableFuture<RegistrationResponse> registerTaskExecutor(
			final ResourceManagerGatewayRegisterTaskExecutorParams params,
			final Time timeout) {
	...
	public static Collection<ResourceProfile> createWorkerSlotProfiles(TaskExecutorResourceSpec taskExecutorResourceSpec) {
		final int numSlots = (int) (1.0 / taskExecutorResourceSpec.getDefaultSlotFraction());
